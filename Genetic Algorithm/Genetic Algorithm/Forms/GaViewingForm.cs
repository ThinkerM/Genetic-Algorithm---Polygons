...
namespace Genetic_Algorithm.Forms
{
    ...
    partial class GaViewerForm : Form
    {
        ...
        private void ResolveDisplayedVertexCount()
        {
            ...
            if (displayedVertexCount == SettingsAccessor.PolygonsVertices) return;

            MessageBoxManager.Yes = "Remove";
            MessageBoxManager.No = "Change settings";
            MessageBoxManager.Register();
            var action = MessageBox.Show($"Displayed population vertices count ({displayedVertexCount}) don't match the specified vertex count in settings ({SettingsAccessor.PolygonsVertices})." 
        ...
        private void ReadParametersFromSettings()
        {
            ...
            maxAngleMutationUpdown.Value = SettingsAccessor.AngleMaximumMutation;
            maxDistanceMutationUpdown.Value = (decimal)SettingsAccessor.CentroidDistanceMaximumMutation;
            ...
            verticesCountUpdown.Value = SettingsAccessor.PolygonsVertices;
        ...
        private void saveSettingsButton_Click(object sender, EventArgs e) => SettingsAccessor.SaveSettings();

        private void resetSettingsButton_Click(object sender, EventArgs e)
        {
            SettingsAccessor.ResetToDefaults();
            ReadParametersFromSettings();
        }
        ...
        private void verticesCountUpdown_ValueChanged(object sender, EventArgs e) => SettingsAccessor.PolygonsVertices = (int)verticesCountUpdown.Value;
        ...
        private void maxDistanceMutationUpdown_ValueChanged(object sender, EventArgs e) => SettingsAccessor.CentroidDistanceMaximumMutation = (double)maxDistanceMutationUpdown.Value;
        ...
        private void maxAngleMutationUpdown_ValueChanged(object sender, EventArgs e)
        {
            ...
            SettingsAccessor.AngleMaximumMutation = testInt;
        }

...
namespace Genetic_Algorithm.Forms
{
    ...
    partial class PopulationGeneratorForm : Form
    {
        ...
        GA.Polygon_based.FitnessCalculators.BasicSymmetryFitnessCalculator fitnessCalculator;
        ...
        public PopulationGeneratorForm()
        {
            ...
            fitnessCalculator = new GA.Polygon_based.FitnessCalculators.BasicSymmetryFitnessCalculator();
        ...
        private PolygonIndividual ReproduceImages(LabeledPolygonImage image1, LabeledPolygonImage image2)
            ...
            adapter.Mutate(newIndividual, SettingsAccessor.MutationProbability);
